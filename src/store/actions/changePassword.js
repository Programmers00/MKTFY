...
import { postChangePassword } from "../../api/userInfo/changePassword";
...
export const updateChangePassword = (data) => async () => {
  try {
    ...
    console.error("#Update Change Password Fail", error.response);
  }
};
